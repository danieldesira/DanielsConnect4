    ...
    releases: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            text:
              "Added option for light/dark/system default theme for logged-in players",
          },
          {
            text:
              "Followed more Lighthouse recommendations over installable PWA",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        points: [
          {
            text: "Internal:",
            subPoints: ["Upgraded Common library to 0.2", "Minor code cleanup"],
          },
          {
            text: "Dialogs:",
            subPoints: [
          ...
          {
            text:
              "Opted for official Google signon button in attempt to solve issue with iOS",
          },
        ],
      },
      {
        ...
        points: [
          {
            text:
              "Applied quick fix for credits and changelog pages in dark mode",
          },
      ...
      },
      {
        ...
        points: [
          ...
          {
            text: "Internal:",
            subPoints: ["Code cleanup", "Send token in request header"],
          },
          {
            text: "UI:",
            subPoints: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            text:
              "Introduced Google signon button which is now required for network play",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        points: [
          {
            text:
              "Network mode: Attempt to reconnect after connection is closed",
          },
          {
            text:
              "Network mode: Cleanup events when connection is closed manually",
          },
      ...
      },
      {
        ...
        points: [
          ...
          {
            text:
              "Minor fix: Removed vertical scrollbar when first visiting main menu",
          },
          {
            text:
              "Minor code cleanup: Printing coin colors simplified due to string enum as well as some other refactoring",
          },
          { text: "Network play" },
      ...
      },
      {
        ...
        points: [
          {
            text:
              "Continue UI changes to make it look better as well as improve experience on mobile devices",
          },
        ],
      },
      {
        ...
        points: [
          {
            text:
              "Internal: Configured Webpack to produce a single minified file and sourcemap",
          },
          {
            text:
              "Minor UI changes: Blue background for player names and version number as link to release notes",
          },
      ...
      },
      {
        ...
        points: [
          {
            text:
              "Internal code adjustment (issue 1) - Adjusted board array to read board[col][row]",
          },
          { text: "Styled main menu and introduced release notes link" },
          {
            text:
              "Ported save game state feature from the other implementation (cleaner and also saves when closing the page!)",
          },
        ],
      },
      {
        ...
        points: [
          {
            text:
              "Port from old version adapted to TypeScript syntax and some refactoring (excluding a few features)",
          },
          {
