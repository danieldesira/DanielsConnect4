...
export default class PlayerNameSection {
  ...
  public constructor(playerRedId: string, playerGreenId: string) {
    ...
    if (playerGreenId) {
      ...
      this.playerGreenText = playerGreenContainer.getElementsByTagName(
        "strong"
      )[0];
      this.playerGreenImage = playerGreenContainer.getElementsByTagName(
        "img"
      )[0];
    }
  }
  ...
  public areBothPlayersConnected = (): boolean =>
    !!this.playerRed && !!this.playerGreen;
